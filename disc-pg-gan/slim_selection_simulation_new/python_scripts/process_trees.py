...
def main(opts):
    print("Loading recombination rates file")
    reco_values = load_recos(opts.reco_path)

    print("Loading tree file paths")
    ...
    print("Iteratively processing tree files into matrix")
    ...
    # make dir to write results to
    outdir = "output_processed"
    if not os.path.exists(outdir):
        os.makedirs(outdir)
        
    np.save(outdir + "/" + "matrices_" + suffix, matrices)
    np.save(outdir + "/" + "distances_" + suffix, distances)
    
    np.save(outdir + "/" + "matrices_regions_" + suffix, matrices_regions)
    np.save(outdir + "/" + "distances_regions_"  + suffix, distances_regions)    
